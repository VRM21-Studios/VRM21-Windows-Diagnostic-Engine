...
# Purpose : Analyze system cache, temporary files, and Recycle Bin usage
# ======================================================================
...
try {
    ...
    Write-Host "Warning: Failed to access the Recycle Bin."
}
...
# ======================================================================
# 3. CACHE AND RECYCLE BIN SUMMARY
# ======================================================================
...
Write-Host "  - Use Disk Cleanup or Storage Sense for safe cleanup."
...
# ======================================================================
# 5. JSON EXPORT FOR PYTHON / LLM INTEGRATION
# ======================================================================

$DiagnosticStatus = if ($TotalWaste -lt 500MB) {
    "Clean"
}
elseif ($TotalWaste -lt 2GB) {
    "Moderate"
